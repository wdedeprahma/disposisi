...
<input class="form-control" type="text" name="no_surat" v
alue="<?=$surat->no_surat;?>" placeholder="NO SURAT MASUK" disabled required />
...
<input class="form-control" type="text" name="surat_from"
value="<?=$surat->surat_from;?>" placeholder="SURAT DARI" disabled requir
ed />

</div>
<div class="mb-3">
<label >TUJUAN SURAT <code>*</code></label>
<input class="form-control" type="text" name="surat_to" v
alue="<?=$surat->surat_to;?>" placeholder="TUJUAN SURAT" required />

</div>
<div class="mb-3">
<label >TANGGAL TERIMA SURAT <code>*</code></label>
<input class="form-control" type="date" name="tgl_terima"
value="<?=$surat->tgl_surat;?>" placeholder="TANGGAL TERIMA SURAT" disabled required />
</div>
<div class="mb-3">
...
surat_masuk/<?php echo $surat->image;?>" class="card-img" width ='500'>
