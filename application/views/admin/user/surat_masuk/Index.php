...
<?php if ($this->session->flashdata('success')): ?><div class="alert alert-success" role="alert">
...
getedit/' . $suratdata->id)." class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
